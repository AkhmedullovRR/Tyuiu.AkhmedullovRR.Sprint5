...
using System.IO;
using Tyuiu.AkhmedullovRR.Sprint5.Task6.V4.Lib;

namespace Tyuiu.AkhmedullovRR.Sprint5.Task6.V4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Выполнил: Ахмедуллов Равиль Радикович | ИСТНб-23-1                             *");
            Console.WriteLine("********************************************************************************");
