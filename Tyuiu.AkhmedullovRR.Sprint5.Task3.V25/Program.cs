using Tyuiu.AkhmedullovRR.Sprint5.Task3.V25.Lib;
namespace Tyuiu.AkhmedullovRR.Sprint5.Task3.V25
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #5 | Выполнил: Ахмедуллов Равиль Радикович | ИСТНб-24-1";
